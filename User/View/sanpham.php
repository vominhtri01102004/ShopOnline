...
<div class="col-md-6 col-md-offset-3">
    ...
    <ul class="pagination">
        ...
        if ($current_page > 1 && $page > 1) {
            ...
            if($ac==2){
                echo '<li><a href="index.php?action=sanpham&act=sanphamkhuyenmai&page=' . ($current_page - 1) . '" aria-label="Trang trước">
                <span aria-hidden="true">&laquo;</span></a></li>';
            }
        }
        // Hiển thị số trang
        for ($i = 1; $i <= $page; $i++) {
            ...
            if($ac==2){
                 echo '<li class="' . ($current_page == $i ? 'active' : '') . '"><a href="index.php?action=sanpham&act=sanphamkhuyenmai&page=' . $i . '">' . $i . '</a></li>';
            }
        ...
        if ($current_page < $page && $page > 1) {
            ...
            if($ac==2){
                echo '<li><a href="index.php?action=sanpham&act=sanphamkhuyenmai&page=' . ($current_page + 1) . '" aria-label="Trang sau"><span aria-hidden="true">&raquo;</span></a></li>';
            }
        }
        ?>
    </ul>
