<div class="row col-md-6 col-md-offset-4">
  <form action="index.php?action=cthanghoa&act=cthanghoa_action" method="post" class="formcthanghoa" enctype="multipart/form-data">
    <table class="table">
      ...
      <tr>
        <td colspan="2">
          <input type="submit" name="submit" value="submit"  style="margin-left: 150px; width:200px;border-radius: 30px;">
